...
class PrinterUtils {
  ...
  static void printCurrencyRow(ThermalPrinterPort printer, String label, double amount, int size) {
  ...
  static void printSurcharges(ThermalPrinterPort printer, List<OrderSurchargeModel>? surcharges) {
