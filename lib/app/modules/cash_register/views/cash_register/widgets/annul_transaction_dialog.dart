...
class AnnulTransactionDialog extends StatefulWidget {
  final OrderModel order;
  final void Function(String reason) onSubmit;

  const AnnulTransactionDialog({
    super.key,
    required this.order,
  ...
  @override
  State<AnnulTransactionDialog> createState() => _AnnulTransactionDialogState();
}

class _AnnulTransactionDialogState extends State<AnnulTransactionDialog> {
  ...
  Widget build(BuildContext context) {
    return CustomFormDialog(
      title: 'Anular venta pagada',
      autoClose: false,
      saveText: 'Anular venta',
      formGroup: _form,
      onSave: () {
      ...
      child: Column(
        ...
        children: [
          ...
          CustomReactiveTextField<String>(
            ...
            hintText:
                'Ej: Cliente canceló el pedido, error en el cobro, etc.',
            maxLines: 3,
            maxLength: 500,
            validationMessages: {
    ...
    return Container(
      ...
      child: const Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'Esta acción revertirá el inventario descontado, sacará la venta de los ingresos de caja y dejará la orden como Anulada.',
